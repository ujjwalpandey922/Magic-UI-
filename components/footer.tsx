      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-4">UI Library for Design Engineers</p>
          </div>
          
          <div>
            <h3 className="font-bold mb-4 uppercase text-sm tracking-wider">Product</h3>
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Email Collection</Link></li>
          ...
          <div>
            <h3 className="font-bold mb-4 uppercase text-sm tracking-wider">Community</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-bold mb-4 uppercase text-sm tracking-wider">Legal</h3>
            <ul className="space-y-2">
        ...
        <div className="text-center pt-8 border-t border-white/10">
          ...
          <p className="text-gray-400">Copyright © 2024 Magic UI. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  )
